...
for start in range(0, 1400, 100):
    page_url = "https://courses.harvard.edu/search?fq_coordinated_semester_yr=coordinated_semester_yr%3A%22Jan+to+May+2017+%28Spring+Term%29%22&fq_school_nm=school_nm%3A%22Faculty+of+Arts+and+Sciences%22&fq_credit_level=credit_level%3A%22Undergraduate%22&q=&sort=course_title%20asc&start={}&rows=100".format(start)
